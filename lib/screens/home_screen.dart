...
// No direct model import required; accept dynamic/Map arguments
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final userName = user is Map ? (user['name'] ?? 'Guest') : 'Guest';
    final userEmail = user is Map ? (user['email'] ?? 'No email') : 'No email';
